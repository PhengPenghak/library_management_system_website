    ...
    public function actionUserRoleAction()
    {
        Yii::$app->db->createCommand()->batchInsert(
            ...
            [
                ...
                [35, 10, 'Report', 'report', 'details,library,borrower-book,export-excel-member-joined-library,export-pdf-member-joined-library,export-excel-member-joined-librarys,test,export-pdf-borrow-book,export-excel-borrow-book,borrower-book,book,export-pdf-book,export-excel-book', 1],
