                    ...
                    [
                        ...
                        'buttons' => [
                            'update' => function ($url, $model) {
                                return Html::button('<i class="bi bi-pencil-square"></i>', ['data-title' => 'Update Location Book', 'value' => $url, 'class' => 'btn btn-xs btn-warning modalButton']);
                            },
                        ],
                    ],
                ],
