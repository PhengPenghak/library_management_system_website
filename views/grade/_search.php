...
<div class="formGradeSearch">
    ...
    <div class="d-flex justify-content-end">
        ...
        <div class="ml-5">
            <button type="button" data-title="Add Grade" value="<?= Url::to(['create']) ?>" class="btn btn-lg btn-primary modalButton"><i class="bi bi-plus-square mr-2"></i>Add <span class="d-none d-lg-inline">Grade</span></button>
        </div>
    </div>
