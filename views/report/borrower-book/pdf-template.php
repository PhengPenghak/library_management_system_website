    ...
    <div class="table-responsive"
        ...
        <table class="table table-sm mb-0"
            ...
            <thead class="thead-" style="background-color: #f8f9fa; color: #333; font-weight: bold;">
                <tr>
                    <th
                        style="width:60px; font-size:.9rem; padding: 0.75rem; vertical-align: top; border: 1px solid #dee2e6; text-align: center; border-bottom: 2px solid #dee2e6; color: black;">
                        ល​ /​ រ</th>
                    <th
                        style="width:250px; font-size:.9rem; padding: 0.75rem; vertical-align: top; border: 1px solid #dee2e6; text-align: center; border-bottom: 2px solid #dee2e6; color: black;">
                        ឈ្មោះសិស្ស</th>
                    <th
                        style="width:70px; font-size:.9rem; padding: 0.75rem; vertical-align: top; border: 1px solid #dee2e6; text-align: center; border-bottom: 2px solid #dee2e6; color: black;">
                        ភេទ</th>
                    <th
                        ...
                        ថ្នាក់</th>
                    <th
                        style="width:200px; font-size:.9rem; padding: 0.75rem; vertical-align: top; border: 1px solid #dee2e6; text-align: center; border-bottom: 2px solid #dee2e6; color: black;">
                        ចំណងជើងរឿង</th>
                    <th
            ...
            <tbody>
                ...
                <tr style="background-color: <?= $key % 2 == 0 ? '#f2f2f2' : 'transparent'; ?>">
                    <td style="padding: 0.75rem; vertical-align: top; border: 1px solid #dee2e6; text-align: center;">
                        <?= $borrowerBook['ID'] ?></td>
                    <td style="padding: 0.75rem; vertical-align: top; border: 1px solid #dee2e6; text-align: center;">
                        <?= $borrowerBook['username'] ?></td>
                    <td style="padding: 0.75rem; vertical-align: top; border: 1px solid #dee2e6; text-align: center;">
                        <?= $borrowerBook['gender'] ?></td>
                    <td style="padding: 0.75rem; vertical-align: top; border: 1px solid #dee2e6; text-align: center;">
                        <?= $borrowerBook['grade_title'] ?></td>
                    <td style="padding: 0.75rem; vertical-align: top; border: 1px solid #dee2e6; text-align: center;">
                        <?= $borrowerBook['bookTitle'] ?></td>
                    <td style="padding: 0.75rem; vertical-align: top; border: 1px solid #dee2e6; text-align: center;">
                        <?= $borrowerBook['code'] ?></td>
                    <td style="padding: 0.75rem; vertical-align: top; border: 1px solid #dee2e6; text-align: center;">
                        <?= $borrowerBook['quantity'] ?></td>
                    <td style="padding: 0.75rem; vertical-align: top; border: 1px solid #dee2e6; text-align: center;">
                        <?= Yii::$app->formatter->asDate($borrowerBook['start'], 'php:d/m/Y') ?></td>
                </tr>
                <?php } ?>
            </tbody>
        </table>
