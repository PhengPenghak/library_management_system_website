...
$permissionsBook = User::getUserPermission("book");
$permissionsBorrowBook = User::getUserPermission("borrower-book");
$permissionsUser = User::getUserPermission("user");
$permissionsBookDestirubtion = User::getUserPermission("book-distribution");
$permissionsCategoryBook = User::getUserPermission("category-book");
$permissionsMemberJoinedLibrary = User::getUserPermission("member-joined-library");
$permissionsLocationBook = User::getUserPermission("location-book");
$permissionsEvent = User::getUserPermission("event");
$permissionsGrade = User::getUserPermission("grade");
$permissionsReport = User::getUserPermission("report");
    ...
    <div class="aside-content">
        ...
        <div class="aside-menu overflow-hidden">
            <nav id="stacked-menu" class="stacked-menu">
                <ul class="menu">
                    <li class="menu-item py-1 px-3 has-active">
                        <button type=" button" data-title="បញ្ចូលអ្នកចូលអានសៀវភៅ"
                            value="<?= Url::toRoute(['/member-joined-library/form']) ?>"
                            class="btn btn-lg btn-primary modalButton btn-block"><i
                                class="bi bi-plus-square mr-2"></i>កត់ត្រាអ្នកអាន</span></button>
                    </li>
                    ...
                    <?php if (in_array('view', $permissionsBook)) { ?>
                    ...
                    <?php } ?>
                    <?php if (in_array('index', $permissionsBorrowBook)) { ?>
                    <li class="menu-item py-1 <?= $controller_group == 'borrower-book' ? 'has-active' : ''; ?>">
                        <a href="<?= Url::toRoute(['borrower-book/index']) ?>" class="menu-link">
                            <span class="menu-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 31 28"
                                    fill="none">
                                    <path
                                        d="M28.0938 2.4375C28.6288 2.4375 29.0625 2.95517 29.0625 3.59375V24.4062C29.0625 25.0448 28.6288 25.5625 28.0938 25.5625H2.90625C2.37122 25.5625 1.9375 25.0448 1.9375 24.4062V3.59375C1.9375 2.95517 2.37122 2.4375 2.90625 2.4375H28.0938ZM2.90625 0.125C1.30117 0.125 0 1.67801 0 3.59375V24.4062C0 26.322 1.30117 27.875 2.90625 27.875H28.0938C29.6988 27.875 31 26.322 31 24.4062V3.59375C31 1.67801 29.6988 0.125 28.0938 0.125H2.90625Z"
                                        fill="#4A4A4A" />
                                    <path
                                        d="M5.8125 15.1562C5.8125 14.5177 6.24622 14 6.78125 14H24.2188C24.7538 14 25.1875 14.5177 25.1875 15.1562C25.1875 15.7948 24.7538 16.3125 24.2188 16.3125H6.78125C6.24622 16.3125 5.8125 15.7948 5.8125 15.1562ZM5.8125 19.7812C5.8125 19.1427 6.24622 18.625 6.78125 18.625H18.4062C18.9413 18.625 19.375 19.1427 19.375 19.7812C19.375 20.4198 18.9413 20.9375 18.4062 20.9375H6.78125C6.24622 20.9375 5.8125 20.4198 5.8125 19.7812Z"
                                        fill="#4A4A4A" />
                                    <path
                                        d="M5.8125 8.21875C5.8125 7.58017 6.24622 7.0625 6.78125 7.0625H24.2188C24.7538 7.0625 25.1875 7.58017 25.1875 8.21875V10.5312C25.1875 11.1698 24.7538 11.6875 24.2188 11.6875H6.78125C6.24622 11.6875 5.8125 11.1698 5.8125 10.5312V8.21875Z"
                                        fill="#4A4A4A" />
                                </svg>
                            </span>
                    ...
                    <?php } ?>
                    <?php if (in_array('index', $permissionsMemberJoinedLibrary)) { ?>
                    <li class="menu-item py-1 <?= $controller_group == 'member-joined-library' ? 'has-active' : ''; ?>">
                        <a href="<?= Url::toRoute(['member-joined-library/index']) ?>" class="menu-link">
                            ...
                            <span class="menu-text">អ្នកចូលអានសៀវភៅ</span>
                        </a>
                    </li>
                    <?php } ?>
                    <?php if (in_array('view', $permissionsCategoryBook)) { ?>
                    ...
                    <?php } ?>
                    <?php if (in_array('index', $permissionsGrade)) { ?>
                    ...
                    <?php } ?>
                    <?php if (in_array('view', $permissionsEvent)) { ?>
                        ...
                        <a href="<?= Url::toRoute(['event/index']) ?>" class="menu-link">
                            <span class="menu-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 29 30"
                                    fill="none">
                                    <path
                                        d="M6.34375 0.711426C6.84426 0.711426 7.25 1.11717 7.25 1.61768V2.52393H21.75V1.61768C21.75 1.11717 22.1557 0.711426 22.6562 0.711426C23.1568 0.711426 23.5625 1.11717 23.5625 1.61768V2.52393H25.375C27.377 2.52393 29 4.14689 29 6.14893V26.0864C29 28.0885 27.377 29.7114 25.375 29.7114H3.625C1.62297 29.7114 0 28.0885 0 26.0864V6.14893C0 4.14689 1.62297 2.52393 3.625 2.52393H5.4375V1.61768C5.4375 1.11717 5.84324 0.711426 6.34375 0.711426ZM3.625 4.33643C2.62398 4.33643 1.8125 5.14791 1.8125 6.14893V26.0864C1.8125 27.0874 2.62398 27.8989 3.625 27.8989H25.375C26.376 27.8989 27.1875 27.0874 27.1875 26.0864V6.14893C27.1875 5.14791 26.376 4.33643 25.375 4.33643H3.625Z"
                                        fill="#4A4A4A" />
                                    <path
                                        d="M4.53125 7.96143C4.53125 7.46092 4.93699 7.05518 5.4375 7.05518H23.5625C24.063 7.05518 24.4688 7.46092 24.4688 7.96143V9.77393C24.4688 10.2744 24.063 10.6802 23.5625 10.6802H5.4375C4.93699 10.6802 4.53125 10.2744 4.53125 9.77393V7.96143Z"
                                        fill="#4A4A4A" />
                                    <path
                                        d="M19.9375 14.3052C19.9375 13.8047 20.3432 13.3989 20.8438 13.3989H22.6562C23.1568 13.3989 23.5625 13.8047 23.5625 14.3052V16.1177C23.5625 16.6182 23.1568 17.0239 22.6562 17.0239H20.8438C20.3432 17.0239 19.9375 16.6182 19.9375 16.1177V14.3052Z"
                                        fill="#4A4A4A" />
                                    <path
                                        d="M14.5 14.3052C14.5 13.8047 14.9057 13.3989 15.4062 13.3989H17.2188C17.7193 13.3989 18.125 13.8047 18.125 14.3052V16.1177C18.125 16.6182 17.7193 17.0239 17.2188 17.0239H15.4062C14.9057 17.0239 14.5 16.6182 14.5 16.1177V14.3052Z"
                                        fill="#4A4A4A" />
                                    <path
                                        d="M5.4375 19.7427C5.4375 19.2422 5.84324 18.8364 6.34375 18.8364H8.15625C8.65676 18.8364 9.0625 19.2422 9.0625 19.7427V21.5552C9.0625 22.0557 8.65676 22.4614 8.15625 22.4614H6.34375C5.84324 22.4614 5.4375 22.0557 5.4375 21.5552V19.7427Z"
                                        fill="#4A4A4A" />
                                    <path
                                        d="M10.875 19.7427C10.875 19.2422 11.2807 18.8364 11.7812 18.8364H13.5938C14.0943 18.8364 14.5 19.2422 14.5 19.7427V21.5552C14.5 22.0557 14.0943 22.4614 13.5938 22.4614H11.7812C11.2807 22.4614 10.875 22.0557 10.875 21.5552V19.7427Z"
                                        fill="#4A4A4A" />
                                </svg>
                            </span>
                    ...
                    <?php } ?>
                    <?php if (in_array('details', $permissionsReport)) { ?>
                    ...
                    <li class="menu-item py-1 has-child <?= $controller_group == 'setting' ? 'has-active' : ''; ?>">
                        ...
                        <ul class="menu">
                            <li class="menu-item <?= $controller == 'user' ? 'has-active' : ''; ?> py-1 has-child">
                                ...
                                <ul class="menu">
                                    <li
                                        class="menu-item <?= $controller_action_group == 'setting_user' ? 'has-active' : ''; ?> py-1">
                                        <a href="<?= Yii::getAlias("@web/user/index") ?>"
                                            class="menu-link">អ្នកប្រើប្រាស់</a>
                                    </li>
                                    <li
                                        class="menu-item <?= $controller_action_group == 'setting_role' ? 'has-active' : ''; ?> py-1">
